...
import { sum, getAllMonth } from "../../utils/library";
                    ...
                    <div className="card-body">
                        ...
                        <div className="row mt-6">
                            <div className="col text-center">
                                ...
                                <h3 className="mb-1"><NumberFormat value={sum('Confirmed', props)} displayType={'text'} thousandSeparator={","} decimalSeparator={"."} defaultValue={"-"} /></h3>
                            ...
                            <div className="col text-center">
                                ...
                                <h3 className="mb-1"><NumberFormat value={sum('Recovered', props)} displayType={'text'} thousandSeparator={","} decimalSeparator={"."} defaultValue={"-"} /></h3>
                                <p className="mb-0 text-muted"><span className="text-lg font-weight-700"></span> ORANG</p>
                            </div>
                            <div className="col text-center">
                                <h5 className="font-weight-normal mt-2">MENINGGAL</h5>
                                <h3 className="mb-1"><NumberFormat value={sum('Deaths', props)} displayType={'text'} thousandSeparator={","} decimalSeparator={"."} defaultValue={"-"} /></h3>
                                <p className="mb-0 text-muted"><span className="text-lg font-weight-700"></span> ORANG</p>
                            </div>
                        </div>
                    </div>
